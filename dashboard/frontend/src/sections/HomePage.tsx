  ...
  provider_truth_layer?: {
    ...
    provider_source_map?: {
      ...
      providers?: Array<{
        ...
        provider_truth_learning_score?: number | null
        provider_truth_confidence_adjustment?: number | null
        provider_truth_judged_n?: number
        provider_truth_trust_delta?: string | null
    ...
    provider_truth_learning_score?: {
      ...
      queue_decision_score?: {
        ...
        good_downgrade_count?: number
        risky_downgrade_count?: number
        escalation_sample_n?: number
        good_escalation_count?: number
        noisy_escalation_count?: number
      }
      providers?: Array<{
        provider?: string
    ...
    provider_truth_miss_repair_workbench?: {
      status?: string
      ...
      benefit_risk?: {
        ...
        risk_count?: number
        false_confirm_risk_count?: number
        net_benefit?: number
        benefit_risk_ratio?: number | null
      }
      guardrail_checklist?: Array<{
        name?: string
        passed?: boolean
        note?: string
      }>
    ...
    dashboard_provider_truth_panel?: {
      ...
      learning_accuracy_pct?: number | null
      ...
      miss_workbench_status?: string | null
      miss_workbench_readiness?: string | null
      ...
      miss_risk_case_count?: number
      miss_top_risk_symbol?: string | null
...
function DailyCryptoBriefPanel({
  ...
  onProviderTruthMissReviewAction?: (item: { review_key?: string | null; status?: string | null; risk_count?: number | null }, state: ProviderTruthMissReviewState) => void
            ...
            {(providerTruthPanel.miss_review_key || providerTruthMissReviewPacket.review_key) && onProviderTruthMissReviewAction && (
              <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginTop: 8 }}>
                {([
                  ...
                  const riskCount = providerTruthPanel.miss_risk_case_count ?? providerTruthMissRiskCases.risk_count ?? 0
                  return (
                    <button
                      ...
                      disabled={
                        ...
                        || (state === 'APPROVED_FOR_IMPLEMENTATION' && (packetStatus !== 'READY_FOR_OPERATOR_REVIEW' || riskCount > 0))
                      }
                      onClick={() => onProviderTruthMissReviewAction({ review_key: reviewKey, status: packetStatus, risk_count: riskCount }, state)}
            ...
            <div style={{ ...MONO, fontSize: 8, color: '#9db7ce', marginTop: 5, lineHeight: 1.45 }}>
              {topFallbackRoute?.symbol
                ...
                : topProviderTruthMiss?.symbol
                  ? `${topProviderTruthMiss.symbol} miss ${String(topProviderTruthMiss.severity || 'review').toLowerCase()} · ${String(providerTruthMissWorkbench.patch_type || topProviderTruthMiss.repair_kind || providerTruthPanel.miss_review_repair_kind || 'repair').replace(/_/g, ' ').toLowerCase()}`
                ...
                : topProviderTruthLearning?.provider
                  ? `${topProviderTruthLearning.provider} learning ${fmtPct(topProviderTruthLearning.learning_score)} · adj ${fmtFixed(topProviderTruthLearning.confidence_adjustment, 1)}`
...
export function HomePage() {
  ...
  const recordProviderTruthMissReviewDecision = (
    item: { review_key?: string | null; status?: string | null; risk_count?: number | null },
    state: ProviderTruthMissReviewState,
  ) => {
